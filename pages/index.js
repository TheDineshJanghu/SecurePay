...
import QRButton from '../components/header/QRButton'
...
const Home = () => {
    ...
    return (
        <div className="flex min-h-screen ">
            ...
            <header className="flex w-[250px] flex-col bg-[#000000] p-12">
                ...
                <button className="flex flex-1 items-center justify-center">
                    <QRButton setModalOpen={setTransactionQRModalOpen} userAddress={userAddress} setQrCode={setQrCode} />
                    <TransactionQRModal modalOpen={transactionQRModalOpen} setModalOpen={setTransactionQRModalOpen} userAddress={userAddress} setQrCode={setQrCode} myKey={publicKey} />
                </button>
            ...
            <main className="flex flex-1 flex-col bg-[#000000]">
                <SearchBar />
